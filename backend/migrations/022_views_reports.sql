...
-- NOTE: duplicate of the views commented out in 021_visitor_management.sql.
-- Schema mismatch (students.id/name/class_id/status, fee_structures.class_id/total_amount, attendance table)
-- vs actual schema. Not used by any route. Revisit as part of the Chalo ERP schema reconciliation.
