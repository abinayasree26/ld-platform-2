...
-- NOTE: vw_fee_outstanding / vw_daily_collection / vw_attendance_summary below are commented out.
-- They reference the Chalo ERP blueprint schema (students.id/name/class_id/status, fee_structures.class_id/total_amount,
-- an attendance table) which does not match this project actual schema (students.user_id, class_students, student_attendance, etc).
-- Not used by any route. Revisit as part of the Chalo ERP schema reconciliation.
