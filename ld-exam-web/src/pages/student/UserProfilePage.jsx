  ...
  return (
    <div style={{ display: 'flex', height: '100vh', overflow: 'hidden', background: '#f8fafc', fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <main className="sp-main" style={{ flex: 1, marginLeft: collapsed ? 0 : 220, transition: 'margin-left 0.2s ease', height: '100vh', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        <div className="sp-content" style={{ flex: 1, minHeight: 0, overflowY: 'auto', padding: 32, maxWidth: 700 }}>
          <button
            onClick={() => navigate(-1)}
            style={{ background: '#fff', border: '1px solid #e2e8f0', color: '#475569', fontSize: 13, fontWeight: 700, cursor: 'pointer', padding: '8px 16px', borderRadius: 10, marginBottom: 16, boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}
          >
            Back
          </button>
          <h2 style={{ fontSize: 20, fontWeight: 800, color: '#1e293b', margin: '0 0 20px' }}>
