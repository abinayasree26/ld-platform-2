...
import { CERTIFICATE_TYPES, HOW_TO_EARN } from '../../../data/certificateTypes';
            ...
            <>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 16, alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                  ...
                  <div>
                    <h2 style={{ fontSize: 28, fontWeight: 800, color: '#1e293b', margin: 0, display: 'flex', alignItems: 'center' }}>
                      🎓 Certification
                      <AboutIcon
                        title="About Certification"
                        description="Earn badges and certificates as you master skills and complete milestones."
                        items={['Complete practice sessions to earn badges', 'Achieve mastery levels in each subject', 'Download and share your certificates', 'Track your earned vs total certifications']}
                      />
                    </h2>
